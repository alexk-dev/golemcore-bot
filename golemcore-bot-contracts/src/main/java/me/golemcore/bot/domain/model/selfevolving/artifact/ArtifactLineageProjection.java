...
/**
 * Graph lineage plus ordered UI rail projection for one stream.
 */
@Data
@Builder
@NoArgsConstructor
...
public class ArtifactLineageProjection {
    ...
    @Builder.Default
    private List<ArtifactLineageNode> nodes = new ArrayList<>();

    @Builder.Default
    private List<ArtifactLineageEdge> edges = new ArrayList<>();
