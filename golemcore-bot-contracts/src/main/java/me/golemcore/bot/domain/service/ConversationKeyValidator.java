...
public final class ConversationKeyValidator {
     ...
     */
    public static String normalizeForActivationOrThrow(String value, Predicate<String> legacyExistsPredicate) {
    ...
    public static Comparator<AgentSession> byRecentActivity() {
        return Comparator.comparing((AgentSession session) -> session.getUpdatedAt() != null ? session.getUpdatedAt()
                : session.getCreatedAt(), Comparator.nullsFirst(Comparator.naturalOrder())).reversed();
    }
