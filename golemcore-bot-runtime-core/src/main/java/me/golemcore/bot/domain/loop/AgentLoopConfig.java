...
/**
 * Configuration parameters for the agent processing loop. Controls iteration limits, temperature, feature toggles
 * (memory, skills, streaming), and system execution timeouts.
 */
@Data
@Builder
