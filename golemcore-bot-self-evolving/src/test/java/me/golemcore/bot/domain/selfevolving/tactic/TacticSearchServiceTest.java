    ...
    void setUp() {
        ...
        RuntimeConfig runtimeConfig = RuntimeConfig.builder()
                .selfEvolving(RuntimeConfig.SelfEvolvingConfig.builder()
                        ...
                        .build())
                .build();
        when(runtimeConfigPort.getSelfEvolvingConfig()).thenReturn(runtimeConfig.getSelfEvolving());

        when(runtimeConfigPort.isTacticQueryExpansionEnabled()).thenReturn(false);
        queryExpansionService = new TacticQueryExpansionService(runtimeConfigPort, null, null, new ObjectMapper());
        tacticSearchService = new TacticSearchService(queryExpansionService, bm25IndexService, runtimeConfigPort,
                null, null, null);
    }
