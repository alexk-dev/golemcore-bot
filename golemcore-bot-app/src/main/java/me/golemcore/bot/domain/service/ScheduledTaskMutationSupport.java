...
final class ScheduledTaskMutationSupport {
    ...
    static ScheduledTask createTask(
            String title,
            String description,
            String prompt,
    ...
    static void applyUpdate(
        ...
        task.setShellWorkingDirectory(resolveUpdatedShellWorkingDirectory(
                task,
    ...
    private static String normalizeShellCommand(
            ScheduledTask.ExecutionMode executionMode,
            String shellCommand) {
        if (executionMode != ScheduledTask.ExecutionMode.SHELL_COMMAND) {
            return null;
    ...
    private static String normalizeShellWorkingDirectory(
            ScheduledTask.ExecutionMode executionMode,
            String shellWorkingDirectory) {
        if (executionMode != ScheduledTask.ExecutionMode.SHELL_COMMAND) {
            return null;
    ...
    private static String resolveUpdatedShellCommand(
    ...
    private static String resolveUpdatedShellWorkingDirectory(
            ScheduledTask existingTask,
            ScheduledTask.ExecutionMode executionMode,
            String shellWorkingDirectory) {
        if (executionMode != ScheduledTask.ExecutionMode.SHELL_COMMAND) {
        ...
        String requested = shellWorkingDirectory != null
                ? shellWorkingDirectory
