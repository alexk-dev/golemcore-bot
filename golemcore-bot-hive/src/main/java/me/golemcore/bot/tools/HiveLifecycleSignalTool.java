...
public class HiveLifecycleSignalTool implements ToolComponent {
    ...
    private static final List<String> SUPPORTED_SIGNAL_TYPES = HiveRuntimeContracts.SUPPORTED_LIFECYCLE_SIGNAL_TYPES;
    ...
    public boolean isEnabled() {
        return HiveRuntimeConfigSupport.isHiveSdlcLifecycleSignalEnabled(runtimeConfigQueryPort.getRuntimeConfig());
    }
