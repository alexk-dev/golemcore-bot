...
public class HiveGetCardTool implements ToolComponent {
    ...
    public ToolDefinition getDefinition() {
        return ToolDefinition.builder()
                ...
                .description("Read a Hive card by card_id, or the current active Hive card when card_id is omitted.")
                .inputSchema(Map.of(
                        "type", "object",
                        "properties", Map.of(
                                "card_id", Map.of(
    ...
    public boolean isEnabled() {
        return HiveRuntimeConfigSupport.isHiveSdlcCardReadEnabled(runtimeConfigQueryPort.getRuntimeConfig());
    }
