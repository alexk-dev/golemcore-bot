...
/**
 * Applies canonical normalization, identity matching, merge, and decay rules
 * for structured memory records.
 */
@Service
...
public class MemoryNormalizationService {
    ...
    public MemoryItem normalizeForLayer(MemoryItem source, MemoryItem.Layer layer, String scope) {
        ...
        normalized.setScope(MemoryScopeSupport.normalizeScopeOrGlobal(
                scope != null ? scope : source != null ? source.getScope() : null));
