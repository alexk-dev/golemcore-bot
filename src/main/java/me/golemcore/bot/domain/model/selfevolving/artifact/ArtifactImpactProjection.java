...
/**
 * Joined quality, cost, latency, benchmark, and regression impact summary.
 */
@Data
@Builder
@NoArgsConstructor
...
public class ArtifactImpactProjection {
    ...
    private Integer campaignDelta;
    private Boolean regressionIntroduced;
    private Boolean regressionResolved;
