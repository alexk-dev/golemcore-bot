...
final class CandidateLifecycleResolver {
    ...
    static String resolveLifecycleState(String status) {
    ...
    static String resolveRolloutStage(String status) {
        if (StringValueSupport.isBlank(status)) {
            return "proposed";
        }
        return switch (status) {
    ...
    static String resolveLegacyStatus(String lifecycleState, String rolloutStage) {
