...
/**
 * Utilities for storing and restoring canonical trace metadata on messages and
 * context attributes.
 */
public final class TraceContextSupport {
    ...
    public static Map<String, Object> ensureRootMetadata(
            Map<String, Object> metadata,
            TraceSpanKind rootKind,
            String traceName) {
    ...
    public static TraceContext createRootContext(TraceSpanKind rootKind) {
        return TraceContext.builder()
                ...
                .parentSpanId(null)
                .rootKind(rootKind != null ? rootKind.name() : null)
                .build();
    }
    ...
    public static TraceContext readTraceContext(Map<String, Object> source) {
        ...
        return TraceContext.builder()
                ...
                .rootKind(readString(source, ContextAttributes.TRACE_ROOT_KIND))
                .build();
    }
