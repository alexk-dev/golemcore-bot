 ...
 *
 * <p>
 * Raw session history is intentionally untouched. Cleanup only removes
 * attributes that are request/iteration artifacts and can be rebuilt by later
 * systems.
 */
public class DefaultContextHygieneService implements ContextHygieneService {
    ...
    private void add(Map<String, ContextAttributeSpec> values, String key, ContextScope scope,
            boolean promptVisible, boolean traceVisible) {
