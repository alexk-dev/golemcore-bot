package me.golemcore.bot.plugin.builtin.whisper.adapter;
 ...
 *
 * <p>
 * This is an adapter-layer component, not a {@link VoicePort} implementation.
 * Routing from the domain is handled by {@link ElevenLabsAdapter}.
 */
@Component
