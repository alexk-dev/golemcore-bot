...
class SessionSelectionServiceTest {
    ...
    void shouldCreateFreshOwnedSessionInsteadOfReusingAnotherClientsWebSession() {
        ...
        AgentSession foreignSession = AgentSession.builder()
                .id("web:foreign-session")
                .channelType("web")
                .chatId("foreign-session")
                .metadata(new HashMap<>())
                .updatedAt(Instant.parse("2026-02-22T10:00:00Z"))
                .messages(List.of())
                .build();
        ...
        when(sessionPort.getOrCreate(eq("web"), anyString())).thenAnswer(invocation -> AgentSession.builder()
                .id("web:" + invocation.getArgument(1, String.class))
                .channelType("web")
                .chatId(invocation.getArgument(1, String.class))
                .messages(List.of())
                .build());
        ...
        assertEquals("client-1",
                SessionIdentitySupport.resolveWebClientInstanceId(sessionCaptor.getValue()));
    }
