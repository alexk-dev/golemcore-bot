...
public class StorageRuntimeConfigPersistenceAdapter implements RuntimeConfigPersistencePort {
    ...
    public RuntimeConfig loadOrCreate() {
        ...
        RuntimeConfig.LlmConfig llm = loadSection(RuntimeConfig.ConfigSection.LLM, RuntimeConfig.LlmConfig.class,
                RuntimeConfig.LlmConfig::new, true);
        ...
        RuntimeConfig.TurnConfig turn = loadSection(RuntimeConfig.ConfigSection.TURN, RuntimeConfig.TurnConfig.class,
                RuntimeConfig.TurnConfig::new, true);
        ...
        RuntimeConfig.SessionRetentionConfig sessionRetention = loadSection(
                RuntimeConfig.ConfigSection.SESSION_RETENTION, RuntimeConfig.SessionRetentionConfig.class,
                RuntimeConfig.SessionRetentionConfig::new, true);
        ...
        RuntimeConfig.TelemetryConfig telemetry = loadSection(RuntimeConfig.ConfigSection.TELEMETRY,
                RuntimeConfig.TelemetryConfig.class,
                () -> RuntimeConfig.TelemetryConfig.builder().enabled(!hasPersistedRuntimeSection).build(), true);
        RuntimeConfig.McpConfig mcp = loadSection(RuntimeConfig.ConfigSection.MCP, RuntimeConfig.McpConfig.class,
                RuntimeConfig.McpConfig::new, true);
        RuntimeConfig.PlanConfig plan = loadSection(RuntimeConfig.ConfigSection.PLAN, RuntimeConfig.PlanConfig.class,
                RuntimeConfig.PlanConfig::new, true);
        ...
        RuntimeConfig.HiveConfig hive = loadSection(RuntimeConfig.ConfigSection.HIVE, RuntimeConfig.HiveConfig.class,
                RuntimeConfig.HiveConfig::new, true);
        ...
        return RuntimeConfig.builder().telegram(telegram).modelRouter(modelRouter).llm(llm).tools(tools).voice(voice)
                .autoMode(autoMode).update(update).tracing(tracing).rateLimit(rateLimit).security(security)
                .compaction(compaction).turn(turn).toolLoop(toolLoop).sessionRetention(sessionRetention).memory(memory)
                .skills(skills).modelRegistry(modelRegistry).usage(usage).telemetry(telemetry).mcp(mcp).plan(plan)
                .delayedActions(delayedActions).hive(hive).selfEvolving(selfEvolving).resilience(resilience).build();
    }
    ...
    public void persist(RuntimeConfig runtimeConfig) {
        ...
        persistSection(RuntimeConfig.ConfigSection.LLM, runtimeConfig.getLlm(), RuntimeConfig.LlmConfig::new);
        persistSection(RuntimeConfig.ConfigSection.TOOLS, runtimeConfig.getTools(), RuntimeConfig.ToolsConfig::new);
        persistSection(RuntimeConfig.ConfigSection.VOICE, runtimeConfig.getVoice(), RuntimeConfig.VoiceConfig::new);
        persistSection(RuntimeConfig.ConfigSection.AUTO_MODE, runtimeConfig.getAutoMode(),
                RuntimeConfig.AutoModeConfig::new);
        persistSection(RuntimeConfig.ConfigSection.UPDATE, runtimeConfig.getUpdate(), RuntimeConfig.UpdateConfig::new);
        ...
        persistSection(RuntimeConfig.ConfigSection.TURN, runtimeConfig.getTurn(), RuntimeConfig.TurnConfig::new);
        ...
        persistSection(RuntimeConfig.ConfigSection.MEMORY, runtimeConfig.getMemory(), RuntimeConfig.MemoryConfig::new);
        persistSection(RuntimeConfig.ConfigSection.SKILLS, runtimeConfig.getSkills(), RuntimeConfig.SkillsConfig::new);
        ...
        persistSection(RuntimeConfig.ConfigSection.USAGE, runtimeConfig.getUsage(), RuntimeConfig.UsageConfig::new);
        persistSection(RuntimeConfig.ConfigSection.TELEMETRY, runtimeConfig.getTelemetry(),
                RuntimeConfig.TelemetryConfig::new);
        persistSection(RuntimeConfig.ConfigSection.MCP, runtimeConfig.getMcp(), RuntimeConfig.McpConfig::new);
        persistSection(RuntimeConfig.ConfigSection.PLAN, runtimeConfig.getPlan(), RuntimeConfig.PlanConfig::new);
        ...
        persistSection(RuntimeConfig.ConfigSection.HIVE, runtimeConfig.getHive(), RuntimeConfig.HiveConfig::new);
    ...
    private <T> void persistSection(RuntimeConfig.ConfigSection section, T config, Supplier<T> defaultSupplier) {
