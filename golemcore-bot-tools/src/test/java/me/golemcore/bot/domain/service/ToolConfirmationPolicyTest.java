...
class ToolConfirmationPolicyTest {
    ...
    void filesystemDeleteRequiresConfirmation() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_FILESYSTEM)
                .arguments(Map.of(ARG_OPERATION, "delete", ARG_PATH, TEST_FILE)).build();
    ...
    void filesystemReadDoesNotRequireConfirmation() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_FILESYSTEM)
                .arguments(Map.of(ARG_OPERATION, "read_file", ARG_PATH, TEST_FILE)).build();
    ...
    void filesystemWriteDoesNotRequireConfirmation() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_FILESYSTEM)
                .arguments(Map.of(ARG_OPERATION, "write_file", ARG_PATH, TEST_FILE, "content", "hello")).build();
        assertFalse(policy.requiresConfirmation(toolCall));
    }

    @Test
    void shellAlwaysRequiresConfirmation() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_SHELL)
                .arguments(Map.of(ARG_COMMAND, "ls -la")).build();
        assertTrue(policy.requiresConfirmation(toolCall));
    }

    @Test
    void skillManagementDeleteRequiresConfirmation() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_SKILL_MGMT)
                .arguments(Map.of(ARG_OPERATION, "delete_skill", "name", "test")).build();
        assertTrue(policy.requiresConfirmation(toolCall));
    }
    ...
    void skillManagementListDoesNotRequireConfirmation() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_SKILL_MGMT)
                .arguments(Map.of(ARG_OPERATION, "list_skills")).build();
        assertFalse(policy.requiresConfirmation(toolCall));
    }

    @Test
    void unknownToolDoesNotRequireConfirmation() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name("datetime")
                .arguments(Map.of(ARG_OPERATION, "now")).build();
        assertFalse(policy.requiresConfirmation(toolCall));
    }
    ...
    void disabledPolicyNeverRequiresConfirmation() {
        ...
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_SHELL)
                .arguments(Map.of(ARG_COMMAND, "rm -rf test")).build();
    ...
    void describeActionForShellCommand() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_SHELL)
                .arguments(Map.of(ARG_COMMAND, "echo hello")).build();
        String description = policy.describeAction(toolCall);
    ...
    void describeActionForShellTruncatesLongCommand() {
        ...
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_SHELL)
                .arguments(Map.of(ARG_COMMAND, longCommand)).build();
        String description = policy.describeAction(toolCall);
    ...
    void describeActionForSkillDelete() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_SKILL_MGMT)
                .arguments(Map.of(ARG_OPERATION, "delete_skill", "name", "my-skill")).build();
        String description = policy.describeAction(toolCall);
    ...
    void shouldNotRequireConfirmationWhenFilesystemArgsNull() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_FILESYSTEM).arguments(null)
                .build();
        assertFalse(policy.requiresConfirmation(toolCall));
    }
    ...
    void shouldNotRequireConfirmationWhenSkillManagementArgsNull() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_SKILL_MGMT).arguments(null)
                .build();
        assertFalse(policy.requiresConfirmation(toolCall));
    }
    ...
    void shouldDescribeFilesystemDeleteWithNullPath() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_FILESYSTEM)
                .arguments(Map.of(ARG_OPERATION, "delete")).build();
        String description = policy.describeAction(toolCall);
        assertTrue(description.contains("Delete file"));
    ...
    void shouldDescribeShellWithNullArgs() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_SHELL).arguments(null)
                .build();
        String description = policy.describeAction(toolCall);
        assertTrue(description.contains("Run command"));
    }
    ...
    void shouldDescribeSkillDeleteWithNullName() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_SKILL_MGMT)
                .arguments(Map.of(ARG_OPERATION, "delete_skill")).build();
        String description = policy.describeAction(toolCall);
        assertTrue(description.contains("Delete skill"));
        assertTrue(description.contains("unknown"));
    }
    ...
    void shouldDescribeUnknownTool() {
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name("custom_tool")
                .arguments(Map.of("key", "value")).build();
        String description = policy.describeAction(toolCall);
    ...
    void shouldDescribeShellCommandExactlyAtThreshold() {
        ...
        Message.ToolCall toolCall = Message.ToolCall.builder().id(TOOL_CALL_ID).name(TOOL_SHELL)
                .arguments(Map.of(ARG_COMMAND, command)).build();
        String description = policy.describeAction(toolCall);
