 ...
 * <p>
 * The factory applies runtime defaults early so the calling orchestrators can read as a short sequence of steps without
 * repeating top-k and budget fallback logic.
 */
@Service
