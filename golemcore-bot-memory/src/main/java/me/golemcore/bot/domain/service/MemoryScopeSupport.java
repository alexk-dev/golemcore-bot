...
public final class MemoryScopeSupport {
    ...
    public static List<String> resolveScopeChain(AgentSession session, String runKind, String goalId, String taskId) {
        String sessionScope = resolveScopeFromSessionOrGlobal(session);
        return buildScopeChain(sessionScope, runKind, goalId, taskId);
    }

    public static List<String> buildScopeChain(String sessionScope, String runKind, String goalId, String taskId) {
