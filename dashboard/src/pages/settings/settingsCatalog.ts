...
export const SETTINGS_SECTIONS = [
  ...
  { key: 'updates', title: 'Updates', description: 'Prepare/apply in-place updates with confirmation', icon: FiRefreshCw },
...
export const SETTINGS_BLOCKS: SettingsBlock[] = [
  ...
  },
  {
    ...
    sections: ['voice-elevenlabs', 'memory', 'skills', 'turn', 'usage', 'rag', 'mcp', 'auto', 'webhooks', 'updates'],
  },
  {
    key: 'advanced',
    title: 'Advanced',
