...
export const SETTINGS_SECTIONS = [
  ...
  { key: 'usage', title: 'Usage & Retention', description: 'Analytics tracking and automatic session cleanup', icon: FiBarChart2 },
...
export const SETTINGS_BLOCKS: SettingsBlock[] = [
  ...
  },
  {
    ...
    sections: ['memory', 'skills', 'turn', 'usage', 'telemetry', 'mcp', 'hive', 'self-evolving', 'auto', 'plan', 'tracing', 'updates'],
  },
  {
    key: 'advanced',
    title: 'Advanced',
