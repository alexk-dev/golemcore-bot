    ...
    return (
      <Card className="settings-card plugin-market-hero mb-3">
        <Card.Body className="d-flex align-items-center gap-2">
          ...
          <span className="small text-body-secondary">Loading skills marketplace...</span>
        </Card.Body>
      </Card>
    );
  }
      ...
      <Card className="settings-card mb-3">
        <Card.Body>
          <Alert variant="warning" className="mb-0">
            Unable to load skills marketplace metadata from backend.
          </Alert>
        </Card.Body>
      </Card>
    );
      ...
      <Card className="settings-card plugin-market-hero mb-3">
        <Card.Body>
          <div className="plugin-market-hero-head">
            <div>
              <div className="plugin-market-eyebrow">Skill Library</div>
              <h3 className="h5 mb-2">Skills Marketplace</h3>
              <p className="text-body-secondary mb-0 plugin-market-hero-copy">
                Install production-ready skills from repository metadata and apply them immediately in runtime.
              </p>
            </div>
            <div className="plugin-market-hero-stats" aria-label="Skills marketplace statistics">
          ...
          <Row className="g-3 mt-1 align-items-end">
            <Col lg={7}>
              <Form.Group controlId="skill-marketplace-search">
            ...
            <Col lg={5}>
              <div className="plugin-market-filter-row" role="tablist" aria-label="Skills marketplace filters">
                {([
      ...
      {catalog.available && items.length === 0 && (
        <Card className="settings-card plugin-market-empty">
          <Card.Body>
            ...
            <h3 className="h6 mb-1">No skills match this search</h3>
