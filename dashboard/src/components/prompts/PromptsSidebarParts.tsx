...
export function PromptCreateCard({
  ...
  return (
    <div className="rounded-2xl border border-dashed border-border/80 bg-muted/20 p-4">
      ...
      <div className="prompt-create-row mt-4 flex gap-2">
        <Input
          value={newPromptName}
...
export function PromptCatalogItem({
  ...
  return (
    <div
      ...
      onDragEnd={onDragEnd}
      className={cn(
        'prompt-catalog-item rounded-3xl border p-4 transition-all duration-200',
        isSelected
    ...
    >
      <div className="prompt-catalog-item-main flex items-start justify-between gap-3">
        <button type="button" onClick={() => onSelect(section)} className="min-w-0 flex-1 text-left">
          <div className="flex items-center gap-2">
            ...
            <div className="prompt-catalog-item-title truncate text-sm font-semibold text-foreground">{section.name}</div>
          </div>
        ...
        <div className="prompt-catalog-item-actions flex shrink-0 items-start gap-2">
